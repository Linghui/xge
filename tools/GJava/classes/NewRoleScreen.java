...
public class NewRoleScreen extends TacticsScreen implements GMessageProcessInterface{

    private String TAG = "NewRoleScreen";
    ...
    public NewRoleScreen(Game game, AssetManager manager){
        super(game, 800, 480);
    ...
    private void initButtons(){
        ...
        TextButton btn1 = new TextButton("创建",skin.get(TextButtonStyle.class));
        btn1.setName("btn1");
        btn1.setX(350);
        btn1.setY(100);
    ...
    private void initTextFields(){
        ...
        username.setX(300);
        username.setY(150);
        username.setMessageText("角色名");
        this.addActorBackground(username);
