...
public class FormationPanel extends Table {

    private String TAG = "FormationPanel";
    
    private AssetManager manager = null;
    private Skin skin = null;
    public FormationPanelActions actions = null;
    
    
    public FormationPanel(AssetManager manager, Skin skin) {
        this.manager = manager;
        this.skin = skin;

        actions = new FormationPanelActions(manager, skin, this);
