...
public class GenHalfPanel extends Table {

    private String TAG = "GenHalfPanel";
    
    private AssetManager manager = null;
    private Skin skin = null;
    public GenHalfPanelActions actions = null;
    
    
    public GenHalfPanel(AssetManager manager, Skin skin) {
        this.manager = manager;
        this.skin = skin;

        actions = new GenHalfPanelActions(manager, skin, this);
