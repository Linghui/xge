...
public class GeneralPanel extends Table {

    private String TAG = "GeneralPanel";
    
    private AssetManager manager = null;
    private Skin skin = null;
    public GeneralPanelActions actions = null;
    
    
    public GeneralPanel(AssetManager manager, Skin skin) {
        this.manager = manager;
        this.skin = skin;

        actions = new GeneralPanelActions(manager, skin, this);
