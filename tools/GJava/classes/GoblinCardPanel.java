...
public class GoblinCardPanel extends Table {

    private String TAG = "GoblinCardPanel";
    
    private AssetManager manager = null;
    private Skin skin = null;
    
    
    public GoblinCardPanel(AssetManager manager, Skin skin) {
    ...
    private void init() {
        ...
        TextureAtlas headAtlas = manager.get("data/head/pack", TextureAtlas.class);

        XCell head1 = new XCell(skin.getPatch("tipsback"), 60, 60, headAtlas);
        head1.setChooseFrame(skin.getPatch("choose-frame"));
        head1.setIcon("30100030");
